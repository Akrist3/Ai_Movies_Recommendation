...
/* Hero */
.hero-wrap { text-align: center; padding: 3rem 1rem 1rem; animation: heroIn 1s cubic-bezier(0.22,1,0.36,1) both; }
@keyframes heroIn {
...
.hero-title {
    ...
    font-size: clamp(4rem, 10vw, 8rem); line-height: 0.9; letter-spacing: 6px;
...
.fancy-divider {
    ...
    background: linear-gradient(90deg,
        transparent 0%, rgba(244,114,182,0.5) 25%,
        rgba(129,140,248,0.5) 50%, rgba(34,211,238,0.5) 75%, transparent 100%);
}
...
[data-testid="stButton"] > button {
    ...
    animation: btnGlow 3s ease-in-out 2s infinite !important;
...
/* Results header */
.results-header {
    font-family: 'Bebas Neue', cursive; font-size: 2.8rem; letter-spacing: 5px;
...
/* Card grid */
.cards-grid {
    display: grid; grid-template-columns: repeat(5, 1fr); gap: 20px; padding: 0 0 3rem;
}
.cine-card {
...
.cine-card:hover {
    ...
    box-shadow: 0 30px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(244,114,182,0.4), 0 0 40px rgba(244,114,182,0.15);
...
.rating-pill {
    ...
    font-size: 0.78rem; font-weight: 700; color: #FFD60A;
...
.card-desc  {
    font-family: 'DM Sans', sans-serif; font-size: 0.75rem; line-height: 1.5;
        ...
        for i, m in enumerate(movies_data):
            ...
            <div class="cine-card pop-{i}">
              <div class="poster-wrap">
                <img class="card-img" src="{m['poster']}" alt="{m['title']}"
